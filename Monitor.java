...
public class Monitor implements Serializable, Runnable {
    ...
    public void waitForGatewayConnection() {
        ...
        int maxIncomingConnections = 10; // maximum length of the queue of incoming connections.

        try {
            serverSocket = new ServerSocket(this.port, maxIncomingConnections, this.ip); // Creates a server with the specified port, listen backlog, and local IP address to bind to
